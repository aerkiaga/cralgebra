...
///
/// This operation raises its first operand to the second
/// and return a value of the type of the former, optionally
...
pub trait PowDyn<
    C,
    D,
    Rhs: ClosedAddDyn<D> + ClosedSubDyn<D> + ZeroDyn<D> + OneDyn<D> + EuclidDyn<D>,
>: Sized + Clone + ClosedMulDyn<C> + OneDyn<C>
{
