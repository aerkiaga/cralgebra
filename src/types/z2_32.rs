...
/// The `Z2^32` integer ring.
///
/// This corresponds to the `u32` type using wrapping arithmetic.
#[repr(transparent)]
...
impl CyclicOrdCostDyn<()> for Z2_32 {
    fn cyclic_lt_cost_d(_ctx: &()) -> f64 {
        2.0 * COSTS.scale * COSTS.cmp.r_32
    }
}
...
impl CyclicOrdZeroCostDyn<()> for Z2_32 {
    fn cyclic_lt0_cost_d(_ctx: &()) -> f64 {
        COSTS.scale * COSTS.cmp.r_32
    }
}
...
impl ClosedAddCostDyn<()> for Z2_32 {
    fn add_cost_d(_ctx: &()) -> f64 {
        COSTS.scale * COSTS.add.r_32
    }
}
...
impl ClosedSubCostDyn<()> for Z2_32 {}
...
impl ClosedMulCostDyn<()> for Z2_32 {
    fn mul_cost_d(_ctx: &()) -> f64 {
        COSTS.scale * COSTS.mul.r_32
    }
}
...
impl CenteredMulCostDyn<()> for Z2_32 {}
...
impl EuclidCostDyn<()> for Z2_32 {
    fn euclid_cost_d(_ctx: &()) -> f64 {
        COSTS.scale * COSTS.div.r_32
    }
}
